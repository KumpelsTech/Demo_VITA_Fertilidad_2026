...
export const MOVEMENTS: Movement[] = [
  ...
  },
  {
    ...
    quantity: 8,
    unit: "bottles",
    from: "Lab Cold Room 1",
    to: "Quarantine area",
    user: "system",
    reason: "Cold-chain excursion 9.4 °C",
  },
  {
    id: "MV-7818",
    ts: "Today · 11:36",
  ...
  },
  {
    id: "MV-7816",
    ts: "Yesterday · 18:50",
    type: "technical-reception",
    lotId: "LOT-9311",
    product: "HSA Solution 5%",
    quantity: 10,
    unit: "bottles",
    from: "Supplier Vitrolife",
    to: "Cold Storage",
    user: "Pharmacy QA",
    reason: "INVIMA registration verified",
  },
  {
    id: "MV-7815",
    ts: "Yesterday · 16:22",
...
export const TEMP_LOGS = [
  {
    sensor: "Cold Room 1",
    location: "Lab · Vitrolife shelf",
    current: 4.1,
    min: 2,
    max: 8,
    status: "ok" as const,
    lastIncident: "12 Feb · 03:14 — 9.4 °C / 22 min",
  },
  {
    sensor: "Cold Shelf 01",
    location: "Pharmacy A",
    current: 5.6,
    min: 2,
    max: 8,
  ...
  {
    sensor: "Cold Shelf 02",
    location: "Pharmacy A",
    current: 7.8,
    min: 2,
    max: 8,
    status: "warning" as const,
    lastIncident: "Today · 09:02 — 8.4 °C / 6 min",
  },
  {
    sensor: "Tank B (LN2)",
    location: "Cold Storage",
  ...
  {
    sensor: "Cart Refrigerator",
    location: "Emergency Cart",
    current: 9.2,
    min: 2,
    max: 8,
    status: "critical" as const,
    lastIncident: "Today · 14:30 — 9.2 °C ongoing",
  },
];
...
export const QUALITY_ITEMS = [
  {
    id: "Q-220",
    type: "INVIMA alert" as const,
    severity: "critical" as const,
    title: "Recall 2024-118 — HSA Solution 5%",
    lot: "LOT-9311",
    affectedPatients: 0,
    status: "Blocked",
    opened: "Yesterday",
  ...
  {
    id: "Q-219",
    type: "Cold-chain incident" as const,
    severity: "warning" as const,
    title: "Excursion at Lab Cold Room 1",
    lot: "LOT-8156",
    affectedPatients: 0,
    status: "Quarantined",
    opened: "Today",
  ...
  {
    id: "Q-218",
    type: "Technical reception" as const,
    severity: "info" as const,
    title: "Vitrolife shipment verified",
    lot: "LOT-9311 · LOT-8156",
    affectedPatients: 0,
  ...
  },
  {
    ...
    severity: "info" as const,
    title: "Destruction request — LOT-7740 (expired)",
    lot: "LOT-7740",
    affectedPatients: 0,
...
export const PRODUCTS: MasterProduct[] = [
  {
    ...
    category: "Hormone",
    unit: "vial",
    presentation: "Pre-filled pen 900IU",
    reference: "GNL-900",
    storage: "2 – 8 °C",
    active: true,
    invima: "INVIMA 2019M-0019283",
    coldChain: true,
    controlled: false,
    suppliers: ["SUP-MRK"],
    stock: 12,
  ...
  },
  {
    ...
    category: "Medication",
    unit: "vial",
    presentation: "Powder + solvent vial",
    reference: "CET-025",
    storage: "Room temp · ≤25°C",
    active: true,
    invima: "INVIMA 2017M-0016654",
    coldChain: false,
    controlled: false,
    suppliers: ["SUP-FRR"],
    stock: 24,
  ...
  },
  {
    ...
    category: "Hormone",
    unit: "capsule",
    presentation: "Soft-gel capsule",
    reference: "PRG-200",
    storage: "Room temp",
    active: true,
    invima: "INVIMA 2015M-0014412",
    coldChain: false,
    controlled: false,
    suppliers: ["SUP-BES"],
    stock: 60,
  ...
  },
  {
    id: "5",
    code: "LAB-005",
    name: "Embryo Culture Medium G-1 PLUS",
    generic: "Sequential culture medium",
    category: "IVF Media",
    unit: "bottle",
    presentation: "20 ml bottle",
    reference: "VIT-G1P",
    storage: "2 – 8 °C",
    active: true,
    invima: "INVIMA DM2018-0009921",
    coldChain: true,
    controlled: false,
    suppliers: ["SUP-VIT"],
    stock: 8,
  ...
  },
  {
    id: "6",
    code: "LAB-006",
    name: "Vitrification Kit Cryotop",
    generic: "Embryo vitrification kit",
    category: "Kit",
    unit: "kit",
    presentation: "Complete kit",
    reference: "KIT-VIT",
    storage: "Room temp",
    active: true,
    invima: "INVIMA DM2019-0010012",
    coldChain: false,
    controlled: false,
    suppliers: ["SUP-KIT"],
    stock: 4,
  ...
  },
  {
    id: "1",
    code: "LAB-007",
    name: "ICSI Pipette Set",
    generic: "Microinjection pipettes",
    category: "Supply",
    unit: "set",
    presentation: "Sterile set",
    reference: "ICS-001",
    storage: "Room temp",
    active: false,
    invima: "INVIMA DM2018-0008812",
    coldChain: false,
    controlled: false,
    suppliers: ["SUP-ORG"],
    stock: 0,
  ...
  },
  {
    ...
    storage: "2 – 8 °C",
    active: true,
    invima: "INVIMA 2017BM-0009123 · RECALL",
    coldChain: true,
    controlled: false,
    suppliers: ["SUP-VIT"],
    stock: 10,
  ...
  },
  {
    ...
    category: "Anesthesia",
    unit: "ampoule",
    presentation: "20 ml ampoule",
    reference: "PRP-200",
    storage: "Room temp",
    active: true,
    invima: "INVIMA 2014M-0013381",
    coldChain: false,
    controlled: true,
    suppliers: ["SUP-FRR"],
    stock: 36,
  ...
  },
  {
    ...
    generic: "Soft-tip transfer catheter",
    category: "Supply",
    unit: "unit",
    presentation: "Sterile sealed",
    reference: "ETC-SFT",
    storage: "Room temp",
    active: true,
    invima: "INVIMA DM2020-0011023",
    coldChain: false,
    controlled: false,
    suppliers: ["SUP-COO"],
    stock: 22,
...
export const SUPPLIERS: Supplier[] = [
  {
    id: "SUP-MRK",
    name: "Merck Serono Colombia",
    nit: "830.014.221-7",
    contact: "Andrea Gómez",
    phone: "+57 310 442 1180",
    email: "a.gomez@merckserono.co",
    address: "Cra 11 #93-46, Bogotá",
    active: true,
    categories: ["Hormone"],
    products: 2,
    openLots: 4,
    lastDelivery: "12 Feb 2025",
    performance: 0.97,
  },
  {
    id: "SUP-FRR",
    ...
    nit: "900.118.776-3",
    contact: "Luis Trujillo",
    phone: "+57 320 998 1145",
    email: "l.trujillo@ferring.com",
    address: "Cl 100 #19-54, Bogotá",
    active: true,
    categories: ["Medication", "Anesthesia"],
    products: 2,
    openLots: 3,
    lastDelivery: "08 Feb 2025",
    performance: 0.93,
  },
  {
    id: "SUP-VIT",
    ...
    phone: "+46 31 721 8000",
    email: "orders@vitrolife.com",
    address: "Göteborg, SE · LATAM hub Bogotá",
    active: true,
    categories: ["IVF Media", "Reagent"],
    products: 2,
    openLots: 2,
    lastDelivery: "Yesterday",
    performance: 0.88,
    notes: "INVIMA recall 2024-118 under review",
  },
  {
    id: "SUP-BES",
    ...
    nit: "900.221.054-8",
    contact: "Camila Ruiz",
    phone: "+57 315 778 0091",
    email: "c.ruiz@besins.co",
    address: "Cl 72 #10-07, Bogotá",
    active: true,
    categories: ["Hormone"],
    products: 1,
    openLots: 1,
    lastDelivery: "02 Feb 2025",
    performance: 0.99,
  },
  {
    id: "SUP-KIT",
    name: "Kitazato Corporation",
    nit: "830.554.117-2",
    contact: "Hiroshi Tanaka",
    phone: "+81 3 5777 2122",
    email: "intl@kitazato.com",
    address: "Tokyo, JP",
    active: true,
    categories: ["Kit"],
    products: 1,
    openLots: 1,
    lastDelivery: "21 Jan 2025",
    performance: 0.95,
  },
  {
    id: "SUP-ORG",
    name: "Origio / CooperSurgical",
    nit: "900.776.314-0",
    contact: "Pablo Esquivel",
    phone: "+57 301 224 7780",
    email: "p.esquivel@coopersurgical.com",
    address: "Cl 116 #9-72, Bogotá",
    active: false,
    categories: ["Supply"],
    products: 1,
    openLots: 0,
    lastDelivery: "12 Nov 2024",
    performance: 0.71,
    notes: "Suspended — ICSI pipette quality complaint Q-209",
  },
  {
    id: "SUP-COO",
    name: "CooperSurgical LATAM",
    nit: "900.117.882-5",
    contact: "Daniela Pardo",
    phone: "+57 318 990 1140",
    email: "d.pardo@coopersurgical.com",
    address: "Cl 116 #9-72, Bogotá",
    active: true,
    categories: ["Supply"],
    products: 1,
    openLots: 2,
    lastDelivery: "04 Feb 2025",
    performance: 0.96,
  },
];
...
export const TRANSFERS: Transfer[] = [
  ...
  },
  {
    ...
    to: "Emergency Cart",
    requester: "J. Pérez",
    receiver: "Pharmacy QA",
    status: "received",
    items: [{ product: "Progesterone 200mg", lot: "LOT-9200", qty: 12, unit: "capsules" }],
  },
  {
    id: "TRF-1040",
    created: "Today · 09:32",
  ...
  },
  {
    id: "TRF-1039",
    created: "Today · 08:05",
    from: "Pharmacy A · Medellín",
    to: "Pharmacy A",
    requester: "Logistics",
    receiver: "—",
    status: "pending",
    items: [{ product: "Gonal-F 900IU", lot: "LOT-8921", qty: 4, unit: "vials" }],
  ...
  },
  {
    ...
    receiver: "Pharmacy QA",
    status: "received",
    items: [{ product: "HSA Solution 5%", lot: "LOT-9311", qty: 10, unit: "bottles" }],
  ...
  },
  {
    ...
    receiver: "—",
    status: "cancelled",
    items: [{ product: "ICSI Pipette Set", lot: "LOT-7740", qty: 2, unit: "sets" }],
...
export const COLD_UNITS: ColdUnit[] = [
  ...
  {
    id: "CU-03",
    name: "Lab Cold Room 1",
    type: "Refrigerator",
    site: "Laboratory · Bogotá",
    range: "2 – 8 °C",
    current: 4.1,
    unit: "°C",
    status: "ok",
  ...
  {
    id: "CU-06",
    name: "Cart Refrigerator",
    type: "Refrigerator",
    site: "Emergency Cart · Bogotá",
    range: "2 – 8 °C",
    current: 9.2,
    unit: "°C",
    status: "critical",
  ...
  {
    id: "CU-08",
    name: "Cold Shelf · Medellín",
    type: "Refrigerator",
    site: "Pharmacy A · Medellín",
    range: "2 – 8 °C",
    current: 0,
    unit: "°C",
    status: "offline",
...
export const INVIMA_ALERTS: InvimaAlert[] = [
  {
    ...
    type: "Recall",
    severity: "critical",
    title: "HSA Solution 5% — manufacturing deviation",
    source: "INVIMA · Resolución 2024-118",
    affectedProducts: ["HSA Solution 5%"],
    affectedLots: ["LOT-9311"],
    clinicImpact: true,
    internalStatus: "actioned",
    actionTaken: "10 bottles quarantined · supplier notified · awaiting QA release",
    notes: "0 patients exposed",
  },
  {
    id: "INV-2025-014",
    published: "18 Feb 2025",
    type: "Technovigilance",
    severity: "warning",
    title: "Cryotop devices — risk of micro-crack on rapid thaw",
    source: "INVIMA · Aviso 2025-014",
    affectedProducts: ["Vitrification Kit Cryotop"],
    affectedLots: ["LOT-8223"],
    clinicImpact: true,
    internalStatus: "in-review",
    actionTaken: "Embryology reviewing affected procedures",
  },
  {
    id: "INV-2025-009",
    ...
    severity: "info",
    title: "Cetrorelix — updated injection-site reaction profile",
    source: "INVIMA · Boletín FV 12",
    affectedProducts: ["Cetrotide 0.25mg"],
    affectedLots: [],
    clinicImpact: false,
    internalStatus: "closed",
    actionTaken: "Patient leaflet updated in WhatsApp templates",
  },
  {
    id: "INV-2025-022",
    published: "Today",
    type: "Falsified",
    severity: "critical",
    title: "Counterfeit Gonal-F detected in informal market",
    source: "INVIMA · Alerta sanitaria 2025-022",
    affectedProducts: ["Gonal-F 900IU"],
    affectedLots: [],
    clinicImpact: false,
    internalStatus: "open",
    notes: "Verify supplier chain — Merck Serono confirmed legitimacy",
  },
  {
    id: "INV-2025-005",
    ...
    type: "Expired",
    severity: "warning",
    title: "Auto-expired lot in Lab Store",
    source: "Internal · system",
    affectedProducts: ["ICSI Pipette Set"],
    affectedLots: ["LOT-7740"],
    clinicImpact: false,
    internalStatus: "actioned",
    actionTaken: "Destruction request raised · pending Director",
  },
];
...
export function movementMeta(type?: MovementType | "pending_dispense" | string | null): {
  label: string;
