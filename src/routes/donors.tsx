...
const donors = [
  { id: "D-1042", name: "Donor #1042", stage: "Active", age: 24, type: "Oocyte", cycles: 3, exams: "Complete", applied: "2023-08-12" },
  { id: "D-1089", name: "Donor #1089", stage: "Pre-screened", age: 26, type: "Sperm", cycles: 0, exams: "Pending", applied: "2024-01-15" },
  { id: "D-1123", name: "Donor #1123", stage: "Interviewed", age: 22, type: "Oocyte", cycles: 0, exams: "Scheduled", applied: "2024-03-02" },
  { id: "D-1056", name: "Donor #1056", stage: "Approved", age: 25, type: "Oocyte", cycles: 1, exams: "Complete", applied: "2023-11-20" },
];

const stages = ["Applied", "Pre-screened", "Contacted", "Interviewed", "Exams", "Approved", "Active", "Archived"];
    ...
    <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">CRM-style workflow for donor screening and management</p>
        </div>
      </div>

      {/* Pipeline */}
      <div className="bg-card border border-border rounded-xl p-5 shadow-sm">
        <h3 className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-4">Donor Pipeline</h3>
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden shadow-sm">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            ...
            <tbody>
              {donors.map((donor) => (
                <tr key={donor.id} className="border-b border-border/50 hover:bg-secondary/30 transition-colors cursor-pointer">
