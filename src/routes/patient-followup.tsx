  ...
  head: () => ({
    meta: [
      { title: "Patient Follow-up — Kumpels Core" },
      {
        name: "description",
        content:
          "WhatsApp-first patient follow-up engine connected to prescriptions, procedures and fertility cases.",
      },
    ],
  }),
});
...
const COUNTDOWNS = [
  ...
  },
  {
    name: "Carmen Miller",
    caseId: "FC-1980",
    med: "Progesterone 200mg",
    at: "22:00",
    remaining: "OVERDUE 5m",
...
const FEED = [
  {
    ...
    caseId: "FC-2031",
    time: "15:02",
    text: "Quick question — ok to take prenatal vitamins together with Ovidrel?",
    tone: "question" as const,
    suggested:
      "Yes — prenatals don't interact with trigger. Take them as usual. The Ovidrel timing is the only one that needs to be exact.",
  },
  {
    who: "Jennifer C.",
    caseId: "FC-2018",
    time: "14:48",
    text: "Confirmed progesterone ✅",
    tone: "ack" as const,
  },
  {
    who: "Sofia P.",
    caseId: "FC-2018",
    time: "11:20",
    text: "Feeling some cramping — should I be worried?",
    tone: "concern" as const,
    suggested:
      "Mild cramping is common after embryo transfer. Rest, hydrate, and reach out if it's sharp, persistent, or with bleeding.",
  },
  {
    who: "Amanda C.",
    caseId: "FC-1994",
    time: "09:00",
    text: "Storage renewal received, thank you!",
    tone: "ack" as const,
  },
];
...
const GUIDANCE = [
  {
    stage: "Day 3 culture · FC-2018",
    title: "Your embryos are in Day 3 culture",
    body: "Next lab update expected tomorrow at 10:00. Rest well — no medication changes needed.",
    sent: "Sent · auto",
  },
  {
    stage: "Trigger · FC-2031",
    title: "Tonight matters",
    body: "Tonight at 21:45 you'll apply Ovidrel. We'll send a 15-min reminder. Procedure is on May 23 at 09:00.",
    sent: "Scheduled · 21:30",
  },
  {
    stage: "Post-OPU · FC-2018",
    title: "What to expect this week",
    body: "Some bloating and mild cramping is normal for 3–4 days. Drink fluids, avoid heavy lifting.",
    sent: "Sent · yesterday",
  },
];
    ...
    <div className="p-6 lg:p-8 max-w-[1500px] mx-auto space-y-6">
      <header className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-[13px] text-muted-foreground mt-1">
            WhatsApp-first care coordination · medication timing, procedure prep, embryo updates and
        ...
        <div className="flex items-center gap-2">
          <Link
            to="/communications"
            className="h-9 px-3 rounded-md bg-secondary text-foreground text-[12px] font-medium inline-flex items-center gap-1.5 hover:bg-accent hover:text-primary"
          >
      ...
      <div className="rounded-xl border border-accent bg-accent/50 p-4 flex gap-3">
        ...
        <p className="text-[12px] text-foreground/85 leading-relaxed">
          <span className="font-semibold text-primary">
            3 patient questions, 1 overdue medication.
          </span>{" "}
          Carmen Miller's progesterone confirmation is 5 minutes overdue — auto-escalation to nurse
          triggered. 2 AI-drafted replies ready for review · 8 follow-up cards scheduled for the
          next 24h.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <Section
            title="Critical medication countdowns"
            kicker="Time-sensitive doses · auto-escalate if missed"
          >
              ...
              {COUNTDOWNS.map((c) => (
                ...
                >
                  ...
                  <button
                    onClick={() => {
                      if (c.status === "overdue") {
                        runMockAction(`Calling ${c.name}`, {
                          detail: "Auto-escalation to nurse",
          ...
          <Section
            title="Patient feed"
            kicker="WhatsApp · AI-drafted replies marked with ✨"
            action={
              <Link
                to="/communications"
                        ...
                        <div className="mt-2 rounded-md bg-accent/40 border border-accent p-2.5">
                          ...
                          <div className="mt-2 flex items-center gap-2">
                            <button
                              ...
                              onClick={async () => {
                                await runMockAction("Sending reply", {
                                  success: `Reply sent to ${m.who}`,
                                });
        ...
        <div className="space-y-6">
          ...
          <Section title="Automation rules" kicker="Active triggers · case-aware">
            <RuleRow
              icon={Clock}
              title="Trigger reminder T-15m"
              subtitle="All cases in trigger phase"
            />
            <RuleRow
              icon={Bell}
              title="Escalate overdue dose"
              subtitle="After 10 min → nurse · 30 min → MD"
            />
            <RuleRow
              icon={Sparkles}
              title="Day 3 / Day 5 update card"
              subtitle="Auto-generated after lab grading"
            />
            <RuleRow
              icon={HeartPulse}
              title="βhCG result narrative"
              subtitle="Friendly, clinically accurate"
            />
          </Section>
        </div>
      </div>
...
function RuleRow({
  ...
  return (
    <div className="flex items-center gap-2.5 py-1.5">
      ...
      <span className="text-[10px] font-medium px-1.5 py-0.5 rounded-full bg-success/10 text-success shrink-0">
        On
      </span>
    </div>
  );
